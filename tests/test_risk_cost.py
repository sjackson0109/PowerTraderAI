...
class TestCostManagementCore(unittest.TestCase):
    ...
    def test_break_even_calculation(self):
        ...
        capital = 100000
        required_return, breakdown = self.cost_manager.calculate_break_even_return(capital)
    ...
    def test_roi_analysis(self):
        ...
        expected_net = performance.total_return - self.cost_manager.monthly_costs.total_annual
...
class TestScalingAnalysis(unittest.TestCase):
    ...
    def test_scaling_efficiency(self):
        ...
        self.assertGreater(five_users['scaled_monthly_cost'], single_user['scaled_monthly_cost'])
        self.assertLess(five_users['scaled_monthly_cost'], single_user['scaled_monthly_cost'] * 5)
